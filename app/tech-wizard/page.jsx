...
export default function TechWizardPage() {
  return (
    <div className="min-h-screen bg-white pt-32 pb-24 font-sans text-[#111827]">
      <div className="w-[90%] mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-16 gap-6 border-b border-gray-100 pb-8">
          ...
          <Link href="#" className="flex items-center gap-3 text-[10px] font-bold uppercase tracking-[0.2em] text-gray-500 hover:text-[#111827] transition-all group shrink-0">
            EXPLORE ALL COURSES
            <span className="w-8 h-8 rounded-full border border-gray-200 flex items-center justify-center group-hover:border-[#111827] transition-all">
